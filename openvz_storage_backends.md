...
| Wasted space due to architecture | No | Yes, up to 20% for allocated ext4 metadate | N/A | Zero |
...
| Backup consistency | Inconsistent | Cosistent with snapshots | Cosistent with snapshots | Consistent with checksummed snapshots |
